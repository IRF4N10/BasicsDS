package LinearArrayOperation;

import java.util.Scanner;

public class LAOperation {
    ...
    void Deletion(int[] array,int n) {
        ...
        System.out.printf("Item %d has been deleted\n", ITEM);
    ...
    void Searching (int[] array,int n){
        ...
        for(int i=0;i<n;i++) {
            ...
            if(f==1) {
                System.out.printf("\nThe value %d is found in the %d number position of the array.\n",ITEM,l);
            }
            else {
